...
namespace Cactus.Infrastructure.NStatsD
{
    public sealed class Client
    {
        ...
        internal static class CurrentClient
        {
            //internal static CurrentClient() { }
        ...
        public StatsDConfigurationSection Config
        {
            get
            {
                ...
                if (_config == null)
                {
                    var confObject = new StatsDConfigurationSection()
                    {
                        Enabled = Convert.ToBoolean(ConfigurationManager.AppSettings["NstatUsage"]),
                        ...
                        ;
                    _config = (StatsDConfigurationSection) confObject;
                }
        ...
        /// <param name="sampleRate">Tells StatsD how often to sample this value. Defaults to 1 (send all values).</param>
        /// <param name="callback">A callback for when the send is complete. Defaults to null.</param>
        public void Timing(string stat, double time, double sampleRate = 1, AsyncCallback callback = null)
        {
            var data = new Dictionary<string, string> { { stat, string.Format("{0}|ms", time) } };
